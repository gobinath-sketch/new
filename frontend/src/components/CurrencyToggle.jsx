...
const CurrencyToggle = ({ checked, onChange }) => {
    return (
        <StyledWrapper>
...
const StyledWrapper = styled.div`
  .toggle-container {
    position: relative;
    width: 100px; /* Reduced width slightly to fit dashboard better */
    display: flex;
    flex-direction: column;
    align-items: center;
    perspective: 800px;
    z-index: 5;
    transform: scale(0.8); /* Scale down a bit to match UI */
  }
  ...
  .data-text {
    position: absolute;
    font-size: 20px; /* Increased font size for currency symbols */
    font-weight: 700;
    letter-spacing: 1px;
  ...
  .data-text.off {
    ...
    opacity: 1;
    color: white;
    text-shadow: 0 0 10px rgba(0, 100, 255, 0.8), 0 0 20px rgba(0, 100, 255, 0.4);
  }
