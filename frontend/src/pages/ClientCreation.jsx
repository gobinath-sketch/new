...
const ClientCreation = ({ user }) => {
  ...
  const updatePhoneNumber = (contactIndex, phoneIndex, value) => {
    const newContacts = [...contactPersons];
    newContacts[contactIndex].phoneNumbers[phoneIndex] = value;
    setContactPersons(newContacts);
  };
                  ...
                  <div className="form-grid">
                    ...
                    <div className="form-group">
                      ...
                      <input 
                        ...
                        onChange={(e) => setFormData({ ...formData, reportingManagerContactNumber: e.target.value })} 
