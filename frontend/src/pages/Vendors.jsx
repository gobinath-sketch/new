  ...
  return (
    <div style={{ width: '100%', minHeight: '100%' }}>
      <div className="page-header">
        <h1 className="page-title">Vendors & Trainers</h1>
        ...
        <form onSubmit={handleSubmit} className="form-card">
          ...
          <div className="form-section">
            ...
            <div className="form-grid">
              ...
              <div className="form-group" style={{ gridColumn: 'span 2', display: 'none' }}>
                <label className="required">Contact Number(s) - Legacy</label>
          ...
          <tbody>
            {vendors.map(vendor => (
              <tr key={vendor._id}>
                ...
                <td>
                  {Array.isArray(vendor.phone) && vendor.phone.length > 0 
                    ? vendor.phone.join(', ') 
                    : vendor.phone || vendor.email || '-'}
                </td>
                <td><span className={`status-badge ${vendor.status.toLowerCase()}`}>{vendor.status}</span></td>
                <td>
                  <button 
                    onClick={() => {
                      const phoneNumbers = Array.isArray(vendor.phone) ? vendor.phone : (vendor.phone ? [vendor.phone] : []);
                      const details = `
VENDOR DETAILS
...
Contact Numbers: ${phoneNumbers.length > 0 ? phoneNumbers.join(', ') : 'N/A'}
Email: ${vendor.email || 'N/A'}
PAN Number: ${vendor.panNumber}
GST Number: ${vendor.gstNumber || 'N/A'}
Bank Name: ${vendor.bankName || 'N/A'}
Bank Account Number: ${vendor.bankAccountNumber || 'N/A'}
Bank Branch Name: ${vendor.bankBranchName || 'N/A'}
Account Type: ${vendor.accountType || 'N/A'}
IFSC Code: ${vendor.ifscCode || 'N/A'}
Status: ${vendor.status}
Created Date: ${new Date(vendor.createdAt).toLocaleString()}
                      `;
                      alert(details);
                    }}
                    className="btn-small"
